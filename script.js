...
const perfumeDetails = {
    ...
    "idole": {
    features: "عطر زهري أنيق من لانكوم يجمع بين روائح الورد والياسمين والفانيليا، يتميز بأناقته ورائحته الأنثوية الرقيقة. مناسب للاستخدام اليومي والمناسبات الخاصة.",
    country: "فرنسا",
    season: "جميع الفصول",
    gender: "نسائي",
    concentration: "Eau de Parfum",
    notes: "القلب: الورد، الياسمين | القاعدة: الفانيليا، المسك"
},
"idole-power": {
    features: "نسخة مكثفة من عطر Idôle تتميز بقوة أكبر وثبات أطول، تجمع بين الزهور البيضاء والفانيليا مع لمسات من المسك. يعطي إحساساً بالثقة والقوة الأنثوية.",
    country: "فرنسا",
    season: "جميع الفصول",
    gender: "نسائي",
    concentration: "Eau de Parfum Intense",
    notes: "القلب: الزهور البيضاء، الفانيليا | القاعدة: المسك، العنبر"
},
"aqua-di-gio-parfum": {
    features: "عطر مائي خشبي للرجال من جورجيو أرماني، يجمع بين روائح البحرية والأعشاب مع لمسات من المسك والعنبر. يتميز بانتعاشه وقوته مع ثبات ممتاز.",
    country: "إيطاليا",
    season: "الصيف",
    gender: "رجالي",
    concentration: "Eau de Parfum",
...
"very-good-girl-elixir": {
    features: "عطر زهري فواكهي مكثف من كارولينا هيريرا، يجمع بين الكشمش الأسود والياسمين والفانيليا. أنثوي وجذاب مع ثبات يصل إلى 12 ساعة. النسخة المطلقة من Very Good Girl.",
    country: "إسبانيا",
    season: "جميع الفصول",
    gender: "نسائي",
    concentration: "Eau de Parfum Intense",
    notes: "القلب: الكشمش الأسود، الياسمين | القاعدة: الفانيليا، المسك"
}
}
